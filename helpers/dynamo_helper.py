...
def close_dynamo_record_order(order_info_obj,transaction_ids, trading_mode):    
    pm_data = order_info_obj['pm_data']
    order_item ={
        'order_id': order_info_obj['order_id'],
        'trade_close_outcome': None,
        ...
        'qty_placed_close': order_info_obj['qty_placed_close'],
        'qty_executed_close': order_info_obj['qty_executed_close'],
        'order_status': order_info_obj['order_status']
    }
    print(order_item)
    response = orders_table.put_item(
